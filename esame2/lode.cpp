...
int num_rec(const int den)
{
    return den;
}

int den_rec(const int num)
{
    return num;
}

void compute_continued_fraction_elements_rec(const int num, const int den, int res[], const int res_maxdim)
{
